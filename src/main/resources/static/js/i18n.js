(function () {
  ...
  var translations = {
    ...
    'RRHH Activos': 'Active HR',
    'Candidatos Registrados': 'Registered Candidates',
    'Candidatos Pendientes': 'Pending Candidates',
    'Candidatos Pendientes de Activaci\u00f3n': 'Pending Activation Candidates',
    'Activos': 'Active',
    'Activo': 'Active',
    'Bloqueado': 'Blocked',
    'Pendiente': 'Pending',
    ...
    'Desbloquear Acceso': 'Unblock Access',
    'USUARIO': 'USER',
    'CORREO': 'EMAIL',
    'DOCUMENTO': 'ID NUMBER',
    'CARGO': 'POSITION',
    ...
    'ACCIONES': 'ACTIONS',
    'Buscar por nombre, correo o documento...': 'Search by name, email or ID...',
    'Todos': 'All',
    'Limpiar': 'Clear',
    'Filtrar': 'Filter',
    'No hay usuarios RRHH registrados.': 'No HR users registered.',
    'Mostrando': 'Showing',
    'a': 'to',
    'de': 'of',
    'Anterior': 'Previous',
    'Siguiente': 'Next',
    'Detalle del Usuario': 'User Details',
    'Cargando...': 'Loading...',
    ...
    'Usuario creado. Se envi\u00f3 el correo de activaci\u00f3n': 'User created. Activation email sent',
